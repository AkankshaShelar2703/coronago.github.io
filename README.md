	...
	<div class = "row w-100 h-100">
		<div class = "col-lg-5 col-md-5 col-12 order-lg-1 order-2">
			<div class ="leftside w-100 h-100 d-flex justify-content-center align-items-center">
				<img src = "imges/earth.png " width="300" hight="300"></div></div>
        <div class = "col-lg-7 col-md-7 col-12 order-lg-2 order-1">
            <div class = "rightside w-100 h-100 d-flex justify-content-center align-items-center">
<h1> Let's stay safe & fight together<br> against cor<span class = "corona_rot"><img src="imges/corona.png" width ="90" hight="90"></span>na virus</h1>
</div></div></div></div>
...
<img src ="imges/corona5.jpg" class="img-fluid"hight="500" width="500"></div>
...
<div class ="row pt-2">
<div class="col-lg-5 col-md-6 col-12 ml-5">
<img src ="imges/corona4.jpg" class="img-fluid"hight="500" width="500"></div>
...
<div class ="container">
	<div class ="row">
		<div class="col-lg-4 col-md-4 col-12 mt-5 pt-2">
			...
			<img src ="imges/cough2.png " class="img-fluid" width="120" height="120">
			<figcaption>PERSISTENT<br> COUGH</figcaption>
			</figure>
			</div>
		<div class="col-lg-4 col-md-4 col-12 mt-5 pb-3">
			<figure class="text-center">
			<img src ="imges/fever3.png" class="img-fluid" width="120" height="120">
			<figcaption>FEVER</figcaption>
			</figure>
			</div>	
		<div class="col-lg-4 col-md-4 col-12 mt-3 ">
			<figure class="text-center">
			<img src ="imges/breath.png" class="img-fluid" width="120" height="120">
			<figcaption>DIFFICULTY<br> BREATHING</figcaption>
			</figure>
			</div>	
		<div class="col-lg-4 col-md-4 col-12 mt-5">
			<figure class="text-center">
			<img src ="imges/3.png" class="img-fluid" width="120" height="120">
			<figcaption>RUNNY NOSE</figcaption>
			</figure>
			</div>	
		<div class="col-lg-4 col-md-4 col-12 mt-5">
			<figure class="text-center">
			<img src ="imges/throat.png" class="img-fluid" width="120" height="120">
			<figcaption>SORE THROAT</figcaption>
			</figure>
			</div>
        <div class="col-lg-4 col-md-4 col-12 mt-5">
			<figure class="text-center">
			<img src ="imges/tired.png" class="img-fluid" width="120" height="120">
	...
	<div class ="row">
		<div class="col-lg-4 col-md-4 col-12 mt-5">
			<div class ="row">
				...
				<figure class="text-center">
				<img src ="imges/handwash7.png " class="img-fluid">
			</figure>
			</div>
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
			<div class ="row">
				<div class="col-lg-4 col-md-4 col-12">
				<figure class="text-center">
				<img src ="imges/distance5.png " class="img-fluid">
			</figure>
			</div>
			<div class="col-lg-8 col-md-8 col-12">
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
			<div class ="row">
				<div class="col-lg-4 col-md-4 col-12">
				<figure class="text-center">
				<img src ="imges/stayhome.png " class="img-fluid">
			</figure>
			</div>
			<div class="col-lg-8 col-md-8 col-12">
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
			<div class ="row">
				<div class="col-lg-4 col-md-4 col-12">
				<figure class="text-center">
				<img src ="imges/covermouth.png " class="img-fluid" >
			</figure>
			</div>
			<div class="col-lg-8 col-md-8 col-12">
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
			<div class ="row">
				<div class="col-lg-4 col-md-4 col-12">
				<figure class="text-center">
				<img src ="imges/onlywearfacemask2.png " class="img-fluid">
			</figure>
			</div>
			<div class="col-lg-8 col-md-8 col-12">
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
			<div class ="row">
				<div class="col-lg-4 col-md-4 col-12">
				<figure class="text-center">
				<img src ="imges/cleansurface.jpg " class="img-fluid">
			</figure>
			</div>
			<div class="col-lg-8 col-md-8 col-12">
...
if(isset($_POST['submit'])){
	...
	$insertquery = "insert into coronacase(username,email,mobile,symp,massage)
